...
| **`brand-content.md` 参照切れ・正式命名・Screen Requirement ID・Acceptance Criteria 確定主体** | (56)(60) | Governance 課題 | SCR-013 §16/§17・README §7・`brand-content.md` 参照切れ | Governance 側 (未整備・参照切れの正本作成/有効性確認は規則 §13) |
