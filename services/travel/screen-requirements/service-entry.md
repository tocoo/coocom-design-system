...
[CTA Principles](../service-design/cta-principles.md) (SD-005) を上流参照する。SCR-001 に関する記述は [../service-design/cta-principles.md](../service-design/cta-principles.md) §7「探索開始と補助導線を競合させない」。Navigation と CTA は別責務とする (UXDR-TRAVEL-003)。
...
- **SD-005 [CTA Principles](../service-design/cta-principles.md)** — CTA-002 One Clear Primary Action / CTA-004 Progressive Commitment / CTA-009 Accessible Activation、§7 SCR-001、§8 Boundary between CTA and Navigation。
