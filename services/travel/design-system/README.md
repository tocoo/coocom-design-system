...
- 改定候補と未解決事項の分離 (Work Order 5)・改定着手可否の判断 (Work Order 6)、および Design System の改定は未着手である。
