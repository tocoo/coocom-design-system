...
| SD-007 | UX Decision Records | UX 設計判断の記録 | Draft |

SD-001〜SD-007 はすべて Draft として実在する ([principles.md](principles.md) / [information-architecture.md](information-architecture.md) / [navigation.md](navigation.md) / [content-principles.md](content-principles.md) / [cta-principles.md](cta-principles.md) / [screen-matrix.md](screen-matrix.md) / [ux-decision-records.md](ux-decision-records.md))。未作成の Planned Artifact はない。
...
8. [UX Decision Records](ux-decision-records.md) (SD-007) — Draft
...
- UX Decision Records (SD-007) が **Draft** として存在する ([ux-decision-records.md](ux-decision-records.md))。
