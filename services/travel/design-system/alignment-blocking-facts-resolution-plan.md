...
| **Price の構造・対象・表示単位・税/手数料/割引/合計・会員差分・販売条件** | (9)(10)(11) | 事業・商品・業務仕様 (料金計算は対象外) | IA-OBJ-007 Does Not Decide (料金構造・表示単位)・SCR-004 §16・§13 | 事業・業務仕様側。IA Includes 語を正式料金仕様に承認せず・PriceTag の存在を課金モデルの根拠にしない |
| **料金計算・API・DB・在庫処理・Review 取得/集計・URL/route/キャッシュ/外部サービス** | (11)(26)(27) | Repository 全体の対象外 | IA §8/§9 (料金計算・在庫管理・API/DB は含まない)・SCR-004 §13/§15・SCR-005 §13/§15 | 対象外として整理 |
