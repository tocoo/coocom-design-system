...
SD-001・SD-002・SD-003・SD-004・SD-006 は Draft として実在する ([principles.md](principles.md) / [information-architecture.md](information-architecture.md) / [navigation.md](navigation.md) / [content-principles.md](content-principles.md) / [screen-matrix.md](screen-matrix.md))。SD-005 (CTA Principles)・SD-007 (UX Decision Records) は未作成であり、実ファイルは存在しない。
...
- CTA Principles (SD-005)・UX Decision Records (SD-007) は未作成。
