...
| --- | --- | --- | --- |
| SD-001 | Service Design Principles | サービス体験設計の原則 | Not started |
| SD-002 | Information Architecture | 情報構造と主要オブジェクトの関係 | Not started |
| SD-003 | Navigation | グローバル・ローカル・文脈ナビゲーション方針 | Not started |
| SD-004 | Content Principles | コンテンツ設計の原則 | Not started |
| SD-005 | CTA Principles | CTA の役割・優先順位・利用原則 | Not started |
| SD-006 | Screen Matrix | 画面一覧・責務・関係の管理 | Not started |
| SD-007 | UX Decision Records | UX 設計判断の記録 | Not started |

上記成果物はいずれも未作成であり、実ファイルは存在しない。
...
1. 本 README
2. Service Design Principles (SD-001) — 未作成
3. Information Architecture (SD-002) — 未作成
4. Navigation (SD-003) — 未作成
5. Content Principles (SD-004) — 未作成
6. CTA Principles (SD-005) — 未作成
7. Screen Matrix (SD-006) — 未作成
...
- Service Design 成果物は現時点で**未作成**。
- 本 README のみが入口として存在する。
...
`Not started` ではなく、入口設計を開始した状態として `In preparation` とする。
