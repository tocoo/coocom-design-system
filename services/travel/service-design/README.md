...
SD-001・SD-002・SD-003・SD-004 は Draft として実在する ([principles.md](principles.md) / [information-architecture.md](information-architecture.md) / [navigation.md](navigation.md) / [content-principles.md](content-principles.md))。SD-005〜007 は未作成であり、実ファイルは存在しない。
...
- その他の Service Design 成果物 (SD-005〜007) は未作成。
